...
1. Read these files (priority):
   ...
   - Examples: seq/seq.c, prng/prng.c, uuid/uuid.c
...
- Memory lifetimes: use udr_alloc (PER_COMMAND) vs udr_alloc_ret (PER_ROUTINE). For iterator state call get_func_state_ptr(sz,fParam) (see seq/seq.c).
